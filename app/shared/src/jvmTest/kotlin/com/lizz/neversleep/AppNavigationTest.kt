...
class AppNavigationTest {
    ...
    fun showcaseListsFeaturesAndNavigatesToGalleryAndBack() {
        ...
        rule.onAllNodesWithText("NeverSleep").assertCountEquals(0)
    ...
    fun pendingDeepLinkIsAppliedOnFirstComposition() {
        check(openAppDeepLink("neversleep://open/notes"))
    ...
    fun warmDeepLinkReplacesOwningStack() {
        ...
        rule.runOnIdle {
            check(openAppDeepLink("neversleep://open/showcase/network"))
        }
        rule.waitUntil(timeoutMillis = 10_000) {
